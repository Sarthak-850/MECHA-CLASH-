...
export const VirtualControls: React.FC<VirtualControlsProps> = ({ engine }) => {
  ...
  return (
    ...
    >
      ...
      {/* ================= RIGHT SIDE: ACTION BUTTONS (ATTACK & DASH) ================= */}
      <div className="relative pointer-events-auto touch-none select-none flex items-end gap-3.5 sm:gap-5 mb-1 mr-1 sm:mb-3 sm:mr-3">
        {/* DASH BUTTON (Secondary thumb action, placed slightly higher or to the left of Attack) */}
